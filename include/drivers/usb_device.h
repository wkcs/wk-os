...
#ifndef  __WK_USB_DEVICE_H__
#define  __WK_USB_DEVICE_H__
...
{
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->set_address != NULL);
...
inline int dcd_set_config(udcd_t dcd, uint8_t address)
{
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->set_config != NULL);
...
inline int dcd_ep_enable(udcd_t dcd, uep_t ep)
{
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->ep_enable != NULL);
...
inline int dcd_ep_disable(udcd_t dcd, uep_t ep)
{
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->ep_disable != NULL);
                                 ...
                                 size_t size)
{
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->ep_write != NULL);
...
inline int dcd_ep0_send_status(udcd_t dcd)
{
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->ep0_send_status != NULL);
...
{    
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->ep_set_stall != NULL);
...
inline int dcd_ep_clear_stall(udcd_t dcd, uint8_t address)
{
    WK_ERROR(dcd != NULL);
    WK_ERROR(dcd->ops != NULL);
    WK_ERROR(dcd->ops->ep_clear_stall != NULL);
